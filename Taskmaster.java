    ...
    public void movement(KeyEvent event) {
        ...
        if ((event.getCode() == KeyCode.UP || event.getCode() == KeyCode.Z)) {
            if (mapbuff[((int) player.getLayoutY() / 16) - 1][(int) (player.getLayoutX() / 16)] == -1
                    || (mapbuff[((int) player.getLayoutY() / 16) - 1][(int) (player.getLayoutX() / 16)] == 210000) // Village -> Maison
                    || (mapbuff[((int) player.getLayoutY() / 16) - 1][(int) (player.getLayoutX() / 16)] == 240) // Plaine -> Chemin de Glace
                    || (mapbuff[((int) player.getLayoutY() / 16) - 1][(int) (player.getLayoutX() / 16)] == 23) // Chemin de Feu -> Plaine
                    || (mapbuff[((int) player.getLayoutY() / 16) - 1][(int) (player.getLayoutX() / 16)] == 300000) // Chemin de Glace -> Donjon de Glace
                    || (mapbuff[((int) player.getLayoutY() / 16) - 1][(int) (player.getLayoutX() / 16)] == 20) // Chemin de Feu -> Donjon de Feu
                    || (mapbuff[((int) player.getLayoutY() / 16) - 1][(int) (player.getLayoutX() / 16)] == 30)) { // Donjon de Feu -> Boss de feu
        ...
        if ((event.getCode() == KeyCode.DOWN || event.getCode() == KeyCode.S)) {
            if (mapbuff[((int) player.getLayoutY() / 16) + 1][(int) (player.getLayoutX() / 16)] == -1
                    || (mapbuff[((int) player.getLayoutY() / 16) + 1][(int) (player.getLayoutX() / 16)] == 200000)  // Maison -> Village
                    || (mapbuff[((int) player.getLayoutY() / 16) + 1][(int) (player.getLayoutX() / 16)] == 280) // Plaine -> Chemin de Feu
                    || (mapbuff[((int) player.getLayoutY() / 16) + 1][(int) (player.getLayoutX() /16)] == 25) // Chemin de Glace -> Plaine
                    || (mapbuff[((int) player.getLayoutY() / 16) + 1][(int) (player.getLayoutX() / 16)] == 60)) { // Donjon de Terre -> Boss de Terre
                player.setLayoutY(player.getLayoutY() + 16);
                bokoblin.setLayoutY(bokoblin.getLayoutY() + 16);
                player.setImage(pv.down());
            }
        ...
        if ((event.getCode() == KeyCode.LEFT || event.getCode() == KeyCode.Q)) {
            if (mapbuff[(int) (player.getLayoutY() / 16)][((int) (player.getLayoutX() / 16)) - 1] == -1
                    || (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16) - 1] == 230) // Plaine -> Village
                    || (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16) -1] == 27)) { // Chemin de Terre -> Plaine
        ...
        if ((event.getCode() == KeyCode.RIGHT || event.getCode() == KeyCode.D)) {
            if (mapbuff[(int) (player.getLayoutY() / 16)][((int) (player.getLayoutX() / 16)) + 1] == -1
                    || (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16) + 1] == 220000) // Village -> Plaine
                    || (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16) + 1] == 260) // Plaine -> Chemin de Terre
                    || (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16)] == 40) // Chemin de Terre -> Donjon de Terre
                    || (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16)] == 90) // Donjon de Glace -> Boss de Glace
                    || (mapbuff[((int) player.getLayoutY() / 16) - 1][(int) (player.getLayoutX() / 16)] == 30)) { // Donjon de Feu -> Boss de feu
                player.setLayoutX(player.getLayoutX() + 16);
                bokoblin.setLayoutX(bokoblin.getLayoutX() + 16);
                player.setImage(pv.right());
        ...
        if (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16)] == 25) {
        ...
        if (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16)] == 300000) {
        ...
        if (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16)] == 90) {
        ...
        if (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16)] == 20) {
        ...
        if (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16)] == 30) {
        ...
        if (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16)] == 40) {
        ...
        if (mapbuff[((int) player.getLayoutY() / 16)][(int) (player.getLayoutX() / 16)] == 60) {
